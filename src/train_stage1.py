...
def train():
    ...
    # num_classes=2: background vs pancreas-region (binary)
    model = UNet(in_channels=1, num_classes=2).to(device)

    # Less extreme weighting than Stage 2 — binary task is simpler
    # Background is much more common, but not as extreme as the cancer imbalance
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            print(f"  -> Saved new best Stage 1 model (val_loss={avg_val_loss:.4f})")
